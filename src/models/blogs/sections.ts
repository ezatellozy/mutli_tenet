...
interface BlogSectionCreationAttributes
  extends Optional<BlogSectionAttributes, "id"> {}
...
interface BlogSectionTranslateCreationAttributes
  extends Optional<BlogSectionTranslateAttributes, "id"> {}

// Blog model

export function registerSectionModels(sequelize: Sequelize) {
  class BlogSection
    extends Model<
      BlogSectionAttributes,
      Optional<BlogSectionCreationAttributes, "id">
    >
    implements BlogSectionAttributes
  {
    declare id: number;
  ...
  class BlogSectionsTranslate
    extends Model<
      BlogSectionTranslateAttributes,
      Optional<BlogSectionTranslateCreationAttributes, "id">
    >
  ...
  return { BlogSection, BlogSectionsTranslate };
}
